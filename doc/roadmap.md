...
| TASK-053: memory-free LLM courier policy | Ready; bounded courier context produces one strict executable proposal or a deterministic Wait fallback with generation evidence, without execution or scheduling. |
