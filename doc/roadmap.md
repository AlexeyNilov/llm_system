...
| Canonical runtime-state contracts | Planned | TASK-011, M2 domain models |
| Outcome, state-change, and canonical-event contracts | Planned | TASK-011, runtime-state contracts |
