...
| [TASK-038](tasks/TASK-038-world-lifecycle.md): deterministic world creation, exact-package resume, and destructive development reset | Ready; depends on validated packages and SQLite V2 repositories |
