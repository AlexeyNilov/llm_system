...
| TASK-049: package-authored initial NPC eligibility | Ready; materialize Greybridge's one-shot caretaker activity into the durable queue at creation/reset without executing scheduled work. |
