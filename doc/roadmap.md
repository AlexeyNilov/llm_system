...
| TASK-054: courier scheduled execution and evidence | Ready; execute one due courier activity through the shared arbiter path and persist its functional-generation evidence atomically. |
