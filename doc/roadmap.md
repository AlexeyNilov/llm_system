...
| TASK-050: one due caretaker scheduled execution | Ready; atomically consume the first due caretaker activity with linked scheduling evidence, leaving other variants and player batching deferred. |
